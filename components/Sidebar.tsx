...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/consentimiento", label: "Informed Consent", icon: <svg className="w-[17px] h-[17px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
      ...
      >
        ...
        <div className="px-4 py-4 flex-shrink-0" style={{ borderTop: "1px solid rgba(167,139,250,0.08)" }}>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10.5px] font-medium" style={{ color: "rgba(167,139,250,0.35)" }}>Grade A Evidence · Level 1</span>
          </div>
