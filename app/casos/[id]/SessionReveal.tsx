...
import type { Sesion } from "@/app/data/casos";
...
export default function SessionReveal({ sesiones, accent }: Props) {
  ...
  return (
    <section className="mb-6">
      <h2 className="text-base font-bold text-[#1e3a5f] mb-2">Sesiones ({sesiones.length})</h2>
      <p className="text-sm text-slate-500 mb-5">
        Reflexiona sobre cada sesión antes de revelar el resultado del terapeuta.
      </p>
              ...
              <div className="border-t border-slate-100">
                {!isRevealed ? (
                  ...
                  >
                    ...
                    Revelar resultado de la sesión
                  </button>
                ) : (
                  <div className="p-5" style={{ background: `${accent}10` }}>
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-xs font-bold uppercase tracking-wider mb-1" style={{ color: accent }}>Resultado</p>
                        <p className="text-sm text-slate-700 leading-relaxed">{sesion.resultado}</p>
                        {sesion.tarea && (
                          <div className="mt-3 pt-3 border-t border-black/5">
                            <p className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">Tarea asignada</p>
