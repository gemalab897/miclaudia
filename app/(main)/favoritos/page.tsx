  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <PageHeader
        ...
        description="Your worksheets marked as favorites"
        badge={`${fichasGuardadas.length} Worksheets`}
      ...
      {fichasGuardadas.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="font-bold text-[#1e3a5f] text-lg mb-2">No saved worksheets yet</h3>
          <p className="text-gray-500 text-sm mb-6 max-w-xs">
            Save your favorite worksheets from the catalog for quick access.
          </p>
          <Link
            href="/fichas"
