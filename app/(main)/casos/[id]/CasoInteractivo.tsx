...
import type { CasoClinico, Sesion } from "@/data/casos";
    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
      <div className="bg-gradient-to-r from-[#1e3a5f] to-[#2a4a6f] px-5 py-4 flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="text-white/60 text-xs">Session {sesion.numero} of {index + 1}</div>
        </div>
      </div>
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div className="bg-emerald-50 rounded-xl p-3">
            <div className="text-xs font-semibold text-emerald-700 mb-1.5">Techniques</div>
        ...
        {!revelado && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-amber-800">Clinical reflection</span>
            </div>
            <p className="text-sm text-amber-700 mb-3">
              Before seeing how this session was conducted: what would you do? What technique would you apply to achieve these goals?
            </p>
            <textarea
              value={respuesta}
          ...
          <div className="space-y-3">
            {respuesta && (
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
                <div className="text-xs font-semibold text-amber-700 mb-1">Your response</div>
                <p className="text-sm text-amber-800">{respuesta}</p>
              </div>
            )}
            <div className="bg-slate-50 rounded-xl p-4">
              <div className="text-xs font-semibold text-gray-500 mb-2">How the session was conducted</div>
            ...
            {sesion.tarea && (
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-3">
                <div className="text-xs font-semibold text-blue-700 mb-1">Homework assignment</div>
        ...
        <div className="pt-2 border-t border-slate-100">
          {esRevisada ? (
            ...
            >
              <span className="text-emerald-500">✓</span> Session reviewed
            </button>
          ) : (
            <button
              onClick={() => toggleRevisada(sesion.numero)}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        <h2 className="text-lg font-bold text-[#1e3a5f] mb-3">Case Presentation</h2>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        >
          <span className="font-bold text-[#1e3a5f]">Cognitive formulation</span>
        ...
        {mostrarFormulacion && (
          <div className="px-6 pb-6 grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-100">
            <div className="mt-4">
              <div className="text-xs font-bold text-gray-500 uppercase mb-2">Relevant history</div>
              <p className="text-sm text-gray-700 leading-relaxed">{caso.formulacionCognitiva.eventosVitales}</p>
            </div>
            <div className="mt-4">
              <div className="text-xs font-bold text-gray-500 uppercase mb-2">Core beliefs</div>
            ...
            <div>
              <div className="text-xs font-bold text-gray-500 uppercase mb-2">Dysfunctional assumptions</div>
              <ul className="space-y-1.5">
