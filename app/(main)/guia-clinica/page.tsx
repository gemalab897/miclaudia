...
import { guiaClinica } from "@/data/guia-clinica";
...
export default function GuiaClinicaPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <PageHeader
        title="Clinical Decision Guide"
        description="Protocol and strategy selection by diagnosis, with key criteria, assessment instruments, and special considerations."
        badge="6 Diagnoses"
        ...
        {guiaClinica.map((dx) => (
          <div key={dx.id} className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div className="mx-6 mb-6 flex items-start gap-2 text-xs text-gray-500">
              ...
              <span><strong className="text-gray-700">Prognosis:</strong> {dx.prognotico}</span>
            </div>
          </div>
        ))}
      </div>
