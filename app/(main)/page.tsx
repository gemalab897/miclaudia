...
const modules = [
  ...
  {
    href: "/teleterapia",
    title: "Consulta Online, Bien Hecha",
    description: "Guía completa de adaptación online: técnicas, alianza terapéutica y manejo de crisis por pantalla.",
    emoji: "💻",
    accent: "#6366f1",
  ...
  {
    href: "/consentimiento",
    title: "Consentimiento Listo en 5 Minutos",
  ...
  },
  {
    ...
    description: "Checklist, preguntas clave y guiones para la primera sesión con el paciente.",
    emoji: "🗓️",
    accent: "#7c3aed",
    bg: "from-violet-500/10 to-violet-600/5",
    border: "border-violet-100",
  ...
  },
  {
    ...
    description: "Glosario clínico de los conceptos esenciales de la TCC con ejemplos concretos.",
    emoji: "📖",
    accent: "#3b82f6",
    bg: "from-blue-500/10 to-blue-600/5",
    border: "border-blue-100",
