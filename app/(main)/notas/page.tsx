    ...
    <div className="max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="mb-8">
        <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium text-white bg-[#1e3a5f] mb-3">
          {notas.length} {notas.length === 1 ? "note" : "notes"}
        </div>
        <h1 className="text-2xl md:text-3xl font-bold text-[#1e3a5f] mb-2">
          Session Notes
        </h1>
        <p className="text-gray-600 text-base leading-relaxed max-w-3xl">
          Record the content of each session, the techniques used, and the
          homework assigned to the patient.
        </p>
      </div>
      ...
      {showForm && (
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 mb-8">
          <h2 className="font-bold text-[#1e3a5f] text-base mb-5">New session note</h2>
          ...
          <div className="mb-4">
            ...
            <input
              type="text"
              placeholder="e.g. Cognitive restructuring, Diaphragmatic breathing, Graduated exposure"
              value={form.tecnicas}
          ...
          <div className="mb-4">
            <label className="block text-xs font-semibold text-slate-500 mb-1.5">
              Session content <span className="text-rose-400">*</span>
            </label>
            <textarea
              rows={6}
              placeholder="Describe what happened in the session, topics covered, patient status..."
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <textarea
                rows={3}
                placeholder="Task or exercise to complete between sessions..."
            ...
            <div>
              ...
              <textarea
                rows={3}
                placeholder="Goals and topics to address in the next session..."
      ...
      {notas.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-slate-500 text-sm max-w-xs leading-relaxed">
            No notes yet. Create the first one using the button above.
          </p>
        </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="ml-2 text-xs text-slate-400">
                      ...
                      {notasPaciente.length === 1 ? "session" : "sessions"}
                    </span>
                  </div>
                  <svg
                            ...
                            {isExpanded && (
                              <div className="px-5 pb-5 border-t border-slate-50 pt-4 space-y-4">
                                ...
                                <p className="text-xs text-slate-300">
                                  Created on{" "}
                                  {new Date(nota.creadaEn).toLocaleString("en-US", {
                                    day: "2-digit",
                                    month: "long",
                                    year: "numeric",
                                    hour: "2-digit",
