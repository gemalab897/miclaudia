...
export default function ProtocolosPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <PageHeader
        title="CBT Clinical Protocols"
        description="10 evidence-based protocols with detailed steps, techniques, materials, and clinical notes for each session."
        badge={`${protocolos.length} Protocols`}
      ...
      <div className="mt-10 bg-gradient-to-r from-[#1e3a5f] to-[#1e4a7f] rounded-2xl p-6 text-white">
        <h3 className="font-bold text-lg mb-2">How to use the protocols?</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-blue-200">
          <div>
            <div className="font-semibold text-white mb-1">1. Select the protocol</div>
            <p>Choose the protocol based on the diagnosis or technique you want to work on in session.</p>
          </div>
          <div>
            <div className="font-semibold text-white mb-1">2. Follow the steps</div>
            <p>Each protocol has numbered steps with descriptions, techniques, and clinical notes.</p>
          </div>
          <div>
            <div className="font-semibold text-white mb-1">3. Use the worksheets</div>
            <p>Each protocol links to related clinical worksheets for use with the patient.</p>
          </div>
        </div>
      </div>
    </div>
