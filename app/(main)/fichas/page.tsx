...
export default function FichasPage() {
  const categorias = ["All", ...Array.from(new Set(fichas.map((f) => f.categoria)))];
    ...
    <div className="max-w-5xl mx-auto px-6 py-10">
      <div className="flex items-start justify-between mb-1">
        <div className="flex-1">
          <PageHeader
            title="Interactive Clinical Worksheets"
            description="Worksheets to complete on screen during the session or print for the patient. All include clinical instructions and notes for the therapist."
            badge={`${fichas.length} Worksheets`}
            ...
            <div key={ficha.id} className="relative">
              ...
              >
                ...
                <div className="flex items-center justify-between mt-4 pt-3 border-t border-slate-100">
                  <span className="text-xs text-gray-400">{ficha.campos.length} fields</span>
              ...
              <button
                ...
                aria-label={esFavorito ? "Remove from favorites" : "Save to favorites"}
      ...
      <div className="mt-10 bg-purple-50 rounded-2xl border border-purple-100 p-6">
        <h3 className="font-bold text-[#1e3a5f] mb-3">How to use the worksheets</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="flex gap-3">
            ...
            <div>
              <div className="font-semibold text-[#1e3a5f] mb-1">Fill in on screen</div>
              <p className="text-gray-500 text-xs">Fill in the fields directly in the browser during the session.</p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              <div className="font-semibold text-[#1e3a5f] mb-1">Print for the patient</div>
              <p className="text-gray-500 text-xs">Use the print button. Worksheets have print-optimized styles.</p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              <div className="font-semibold text-[#1e3a5f] mb-1">Between-session homework</div>
              <p className="text-gray-500 text-xs">Assign worksheets as homework and review them in the next session.</p>
            </div>
          </div>
        </div>
      </div>
