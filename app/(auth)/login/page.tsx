    ...
    >
      <div className="w-full max-w-sm px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-purple-300 text-sm mt-1">Sistema Clínico de TCC</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm text-purple-200 mb-1">Correo electrónico</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-sm text-purple-200 mb-1">Contraseña</label>
            <input
              type="password"
              value={password}
