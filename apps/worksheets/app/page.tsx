    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-6 pt-16 pb-12">
          <div className="max-w-2xl">
            ...
            >
              ...
              Evidence-Based · Ready to Print · Fillable Online
            </div>
            <h1 className="animate-fade-up-2 mb-6">
              ...
              >
                Therapy{" "}
                <span style={{ color: "#14b8a6" }}>Worksheets</span>
              </span>
              <span className="block text-sm mt-3 tracking-[0.22em] uppercase font-medium" style={{ color: "rgba(94,234,212,0.4)" }}>
                Professional Toolkit for Psychologists
              </span>
            </h1>
            <p className="text-[17px] leading-relaxed mb-10 animate-fade-up-3" style={{ color: "rgba(255,255,255,0.48)" }}>
              {worksheets.length}+ interactive, printable worksheets across 8 clinical domains. Fill in session, hand to your client, or assign as homework.
            </p>
        ...
        <div className="relative" style={{ borderTop: "1px solid rgba(20,184,166,0.08)" }}>
          <div className="max-w-5xl mx-auto px-6 py-6 grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { value: `${worksheets.length}+`, label: "Worksheets" },
              { value: `${categories.length}`, label: "Clinical domains" },
              { value: "100%", label: "Interactive & printable" },
              { value: "Free", label: "For your clients" },
            ].map((s) => (
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">Choose a category to browse worksheets</p>
        </div>
        ...
        >
          ...
          <div className="relative">
            ...
            <h3 className="font-bold text-white text-[20px] mb-3 leading-tight">
              Fill in session → Print → Hand to client
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { n: "1", t: "Fill in screen", d: "Complete fields directly in the browser during or before session. Auto-saved to this device." },
                { n: "2", t: "Print for client", d: "Click the Print button. Worksheets use print-optimized styles — no headers, clean layout." },
                { n: "3", t: "Assign as homework", d: "Share the worksheet URL with your client so they can fill it out between sessions." },
              ].map((s) => (
