...
export const ganchos: Gancho[] = [
  ...
  { id: 2, texto: "¿Sentís que tu cabeza no se apaga ni cuando por fin te sentás a descansar?", especialidad: "Ansiedad", nivel: 1, tipo: "Pregunta" },
  ...
  { id: 7, texto: "Si ya identificaste que necesitás ayuda con tu ansiedad, así es como trabajo en las primeras sesiones.", especialidad: "Ansiedad", nivel: 5, tipo: "Caso anonimizado" },
  ...
  { id: 14, texto: "¿Sentís que hace tiempo hablan más de logística que de ustedes como pareja?", especialidad: "Parejas", nivel: 1, tipo: "Pregunta" },
  { id: 15, texto: "Mito: si tenés que ir a terapia de pareja es porque la relación 'ya fracasó'. Realidad: es lo contrario.", especialidad: "Parejas", nivel: 2, tipo: "Mito vs. realidad" },
  ...
  { id: 22, texto: "El diálogo interno que usás con vos mismo/a probablemente no se lo dirías a nadie más.", especialidad: "Autoestima", nivel: 2, tipo: "Dato sorprendente" },
  ...
  { id: 25, texto: "¿Buscás empezar a trabajar en tu autoestima con acompañamiento profesional? Escribime.", especialidad: "Autoestima", nivel: 5, tipo: "Pregunta" },
  { id: 26, texto: "¿Sentís que 'ya debería estar mejor' con tu duelo, aunque nadie te lo dijo directamente?", especialidad: "Duelo", nivel: 1, tipo: "Pregunta" },
  ...
  { id: 29, texto: "¿Notás que tu hijo/a adolescente se aísla más de lo habitual últimamente?", especialidad: "Adolescentes", nivel: 1, tipo: "Pregunta" },
  ...
  { id: 35, texto: "Tengo disponibilidad esta semana para primeras sesiones — escribime si querés dar el paso.", especialidad: "General", nivel: 5, tipo: "Pregunta" },
];
