...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    content: [
      ...
      h3("Cómo investigar sin tener un negocio real todavía"),
  ...
  // ───────────────────── FASE 2 — PRESENCIA Y ATRACCIÓN ─────────────────────
  {
    ...
    content: [
      ...
      h3("Los primeros 9 posts como vitrina"),
  ...
  },
  {
    ...
    content: [
      ...
      h3("Atracción vs. conversión, según el nivel de consciencia"),
  ...
  // ───────────────────── FASE 3 — CONVERSIÓN Y ESCALAMIENTO ─────────────────────
  {
    ...
    content: [
      ...
      list([
        ...
        "\"Prefiero intentarlo solo primero\": validar el intento de autonomía sin desalentarlo, y dejar la puerta abierta con calidez: \"tiene todo el sentido querer intentarlo así. Si en algún momento sentís que te vendría bien acompañamiento, acá vas a tener las puertas abiertas.\"",
      ]),
      h3("El cierre suave"),
      ...
      p("Usa el simulador de esta lección: elegí una objeción típica y mirá el script de respuesta sugerido, listo para adaptar a tu propio estilo."),
    ],
  },
  {
    id: 10,
    ...
    content: [
      ...
      p("Antes de destinar presupuesto a anuncios, verificá que lo orgánico ya esté funcionando: ¿tu perfil convierte visitas en mensajes? ¿tus respuestas logran convertir mensajes en citas agendadas? ¿tu tasa de asistencia a esas citas es razonable? Si la respuesta a alguna de estas preguntas es no, invertir en más tráfico solo amplifica el problema: más personas van a llegar a un sistema que todavía tiene fugas."),
      h3("Estructura de campaña"),
      list([
        "Objetivo: define con claridad qué acción querés que tome la persona que ve el anuncio (mensaje directo, agendar una llamada, visitar un link). Un objetivo difuso arruina la optimización de la campaña.",
        "Segmentación básica: ubicación geográfica relevante para tu consultorio (o país, si trabajás online), rango de edad de tu avatar, e intereses relacionados a tu especialidad.",
      ...
      p("Usa la calculadora de esta lección para estimar, a partir de tu meta de pacientes nuevos por mes y un costo por lead estimado, qué presupuesto mensual sería razonable destinar y qué resultados podés esperar."),
    ],
  },
  ...
  // ───────────────────── FASE 4 — OPERACIÓN Y CRECIMIENTO ─────────────────────
  {
    ...
    content: [
      ...
      p("Pedir que el paciente complete una ficha de intake antes de la primera sesión —datos de contacto, motivo de consulta breve, expectativas— reduce el tiempo administrativo dentro de la sesión y aumenta el compromiso del paciente con el proceso desde antes de sentarse frente a vos."),
      ...
      p("Los pacientes que discontinuaron el proceso sin un cierre formal son una fuente de reactivación válida: un mensaje breve, cálido y sin presión (\"quería saber cómo estás, las puertas siguen abiertas si en algún momento querés retomar\") puede reabrir la conversación sin invadir su proceso personal."),
  ...
  },
  {
    ...
    content: [
      ...
      p("El valor real de estos KPIs está en cómo se leen en conjunto, no de forma aislada. Si generás muchos leads pero pocas citas agendadas, el problema no está en la atracción —eso ya funciona— sino en la conversión: tu script de primera respuesta o tu manejo de objeciones necesita ajustes. Si agendás muchas citas pero la asistencia es baja, el problema está en el seguimiento previo a la sesión, no en el mensaje de venta. Si tenés buena asistencia pero baja continuidad, el problema puede estar en la experiencia de la primera sesión o en cómo se comunica el valor de continuar el proceso."),
      p("Esta forma de diagnosticar evita la trampa más común: cambiar el contenido de Instagram cuando en realidad el problema está en cómo respondés los mensajes, o invertir en publicidad cuando el problema está en la tasa de asistencia. Cada síntoma numérico apunta a un módulo específico de este curso."),
      p("Usa el dashboard de esta lección: ingresá tus números del mes (leads, citas agendadas, citas completadas, pacientes activos, gasto en publicidad) y la herramienta va a calcular automáticamente tus KPIs y sugerirte en qué módulo enfocar tu energía este mes."),
    ],
  },
];
